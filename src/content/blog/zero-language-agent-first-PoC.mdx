...
<FlowDiagram
  title="Agent Loop (shared by Claude Code, Cursor, Aider)"
  steps={[
    { label: "1. Assemble Context", sublabel: "(codebase, instructions, files)" },
    { label: "2. LLM Reasons", sublabel: "Proposes Action" },
    { label: "3. Execute Tool", sublabel: "(compile, edit)" },
    { label: "4. Observe Result", sublabel: "(error, output, file content)" },
  ]}
  annotations={[
    { at: 1, text: "Bottleneck: context window, multi-step planning reliability" },
    { at: 3, text: "Zero's JSON replaces here (~1% of bottleneck)" },
  ]}
  loopback="Back to step 2 until complete"
/>
...
<img src="/charts/agent-reliability-factors.png" alt="Chart comparing factors limiting agent reliability" />
...
<img src="/charts/training-data-availability.png" alt="Chart comparing training data availability across languages" />
...
<img src="/charts/ecosystem-bootstrapping.png" alt="Visualization of the ecosystem bootstrapping problem" />
...
<img src="/charts/viability-doughnut.png" alt="Bottom line: what determines language viability for agents" />
