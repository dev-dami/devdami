...
<FlowDiagram
  title="Data Flow — API to DOM Sink"
  steps={[
    { label: "API/Server", sublabel: "(untrusted)" },
    { label: "TanStack Query", sublabel: "Cache" },
    { label: "Component", sublabel: "render" },
    { label: "dangerouslySet", sublabel: "InnerHTML = query.data", highlight: "danger" },
  ]}
  annotations={[
    { at: 1, text: "No sanitization or output encoding by TanStack Query" },
    { at: 3, text: "React's JSX encoding is BYPASSED here" },
  ]}
/>
