...
<FlowDiagram
  title="Emulator Core Loop — One Tick"
  steps={[
    {
      label: "CPU", sublabel: "executes 1 instruction",
      children: [
        { label: "Timer", sublabel: "÷N, TIMA, TMA" },
        { label: "Audio", sublabel: "4 wave channels" },
        { label: "PPU", sublabel: "scanline render" },
        { label: "Input", sublabel: "button states" },
      ],
    },
  ]}
/>
