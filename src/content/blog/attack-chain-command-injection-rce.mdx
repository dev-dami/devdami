...
<FlowDiagram
  title="Attack Chain — Five Links"
  steps={[
    { label: "1. User Input", sublabel: "passed to shell command", highlight: "danger" },
    { label: "2. Shared Temp File", sublabel: "no locking", highlight: "danger" },
    { label: "3. Race Condition", sublabel: "concurrency exploit", highlight: "danger" },
    { label: "4. Blind Output", sublabel: "no visible response", highlight: "accent" },
    { label: "5. OOB Exfiltration", sublabel: "DNS/HTTP leak", highlight: "accent" },
  ]}
  annotations={[
    { at: 0, text: "Injection surface" },
    { at: 1, text: "Collision point" },
    { at: 2, text: "Probabilistic → Deterministic" },
    { at: 3, text: "Commands execute silently" },
    { at: 4, text: "Attacker retrieves output" },
  ]}
/>
