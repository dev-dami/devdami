...
takeaways: |
  Strategic open-source contributions that reproduce bugs and read architecture beat typo-fixing any day
  "Fake but real" projects with PostgreSQL, CI/CD, rate limiting, and monitoring prove you can ship production code
  Freelance projects chosen for skill gaps (API design, deployment, database optimization) build targeted experience
  Building in public and teaching what you learn creates verifiable credentials that hiring managers trust
  Specific resume bullets with metrics (response times, request volumes, concurrency) outperform generic descriptions
---
...
<FlowDiagram
  steps={[
    { label: "Browser", sublabel: "(React)" },
    {
      ...
      sublabel: "(Node.js)",
      children: [
        { label: "Redis", sublabel: "(Cache)" },
      ],
    },
    { label: "PostgreSQL", sublabel: "(Primary)" },
  ]}
/>
